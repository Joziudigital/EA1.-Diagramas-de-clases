...
El desarrollo de este modelo se realizó con colaboración (utilizamos la plataforma de diagramación para construir un modelo juntos y visualizarlo PLANTUML) y un repositorio de GitHub para el control de versiones, la gestión del equipo, la organización de las contribuciones del equipo y la organización del progreso del proyecto.
...
**Enlace al diagrama:** [Ver imagen en Google Drive](https://drive.google.com/file/d/1kPZg6wfTD67tstUoDb0GPA7_y9NdE4rp/view?usp=sharing)
